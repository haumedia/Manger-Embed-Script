...
function settingss(setting) {
  ...
  if (setting.register == 1) {register = `checked="checked"`;};
  if (setting) {
  ...
  <input class="form-check-input" name="autoplay" type="checkbox" ${autoplay}>
			  ...
			  <div class="form-group mb-3 row">
                  <label class="form-label col-3 col-form-label"><b>On/Off Registration
                  </b></label>
                  <div class="col">
                     <label class="form-check form-switch">
  <input class="form-check-input" name="register" type="checkbox" ${register}>
                     <span class="form-check-label"></span>
                     </label>          <small class="form-hint">Enable/disable Member Registration Feature</small>
                  </div>
               </div>
			  <div class="form-group mb-3 row">
