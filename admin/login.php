...
<h5 class="mb-5 text-center">Login</h5>	
         ...
         <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
			...
			<div class="mb-3">
			 ...
			 <button type="submit" name="submit" class="btn btn-info btn-block">Login</button><br />
			 <div class="text-sm-center d-none d-sm-block">
                                    2021 <i class="mdi mdi-heart text-danger"></i> By <a href="https://www.facebook.com/haun.ytb/" target="_blank" title="Ancokplayer">Hậu Nguyễn</a>
                                </div>
		 </form>