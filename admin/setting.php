...
if (isset($_POST['update'])) {		
		...
		$register = isset($_POST['register']) == 'on' ? 1 : 0;
	...
	try {
        ...
        $sql = "UPDATE settings SET adblock='$adblocka',default_video='$default_videoa',jw_license='$jw_licensea',default_banner='$default_bannera',loading='$loadinga',autoplay='$autoplaya',register='$register'";
